			            		...
			            		<ul class="nav">
			              			...
			              			<li class="dropdown">
			                			...
			                			<ul class="dropdown-menu">
			                  				...
			                  				<li><a href="liontin.php">Liontin</a></li>
			                			</ul>
			              			</li>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM barang where id_Kategori Like '%2'");
		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
          			<div class="icons-box">
                        ...
                        <img src="www.e-gold.com\admin\foto\<?php echo $data['gambar']; ?>" />
						<div><h3>Rp.<?php echo number_format($data['harga'],2,",",".");?></h3></div>
					<!--	<p>
						
						</p> -->
						<div class="clear"><a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['id_Barang'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['id_Barang'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
