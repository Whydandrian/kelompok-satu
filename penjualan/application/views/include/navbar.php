		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'penjualan') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><!-- <i class='fa fa-opencart'></i> --><img src="<?php echo config_item('img'); ?>carts.png" />Penjualan <span class="caret"></span></a>
				...
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><!-- <i class='fa fa-cube fa-fw'></i> --> <img src="<?php echo config_item('img'); ?>item.png" />Barang <span class="caret"></span></a>
					<ul class="dropdown-menu">
